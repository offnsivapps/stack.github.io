...
var squareColors = [0x09fc5e8, 0xffffff];
...
playGame.prototype = {
     preload: function(){
          ...
          game.load.image("square", "square.png");
            ...
            game.load.image("gift", "gift.png");
          game.load.audio('boden', ['h1.mp3']);
          game.load.audio('bg', ['bg1.mp3']);
     ...
     moveSquare: function(){
          ...
          if(this.hero.canMove){
               ...
               moveTween.onComplete.add(function(){
                    ...
                    if(game.rnd.integerInRange(0, 9) < 2){
     ...
     addEnemy: function(){
          ...
          }, 800 + game.rnd.integerInRange(0, 250), Phaser.Easing.Linear.None, true, 0, -1, true);
